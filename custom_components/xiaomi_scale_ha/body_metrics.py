...
class bodyMetrics:
    def __init__(self, weight, height, age, sex, impedance):
        ...
        if self.height > 220:
            raise ValueError("Height is over 220cm")
        elif weight < 10 or weight > 200:
            raise ValueError("Weight is below 10kg or above 200kg")
        elif age > 99:
            raise ValueError("Age is above 99 years")
        elif impedance > 3000:
            raise ValueError("Impedance is above 3000 Ohm")
